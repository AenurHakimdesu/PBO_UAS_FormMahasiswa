...
public class ModelPendaftaran {
    ...
    public ModelPendaftaran(int ID_Siswa, String Nama_Siswa, String Tgl_Lahir, String Asal_Sekolah, String Jenis_Kelamin, String Kota_Asal, String Email_Siswa, int ID_Wali, int ID_Prodi)
    {
