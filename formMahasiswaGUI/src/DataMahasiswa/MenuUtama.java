...
public class MenuUtama extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("APLIKASI PENERIMAAN");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel2.setText("CALON MAHASISWA BARU");

        mnuData.setText("Menu ");

        mnuDTpendaftaran.setText("Data Pendaftaran MHS");
